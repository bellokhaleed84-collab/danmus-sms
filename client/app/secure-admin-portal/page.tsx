...
export default function AdminPage() {
  ...
  if (loading) {
    return (
      <div className="text-center py-20">
        ...
        <h1 className="text-xl font-bold">Loading dashboard data...</h1>
      </div>
    );
  }
  ...
  return (
    <>
      ...
      <div id="users" className="bg-[var(--card)] border border-[var(--border)] rounded-2xl md:rounded-3xl p-4 md:p-8 shadow-2xl scroll-mt-24">
      ...
      <div id="transactions" className="bg-[var(--card)] border border-[var(--border)] rounded-2xl md:rounded-3xl p-4 md:p-8 shadow-2xl mt-8 md:mt-10 scroll-mt-24">
      ...
      <div id="listings" className="bg-[var(--card)] border border-[var(--border)] rounded-2xl md:rounded-3xl p-4 md:p-8 shadow-2xl mt-8 md:mt-10 scroll-mt-24">
      ...
      <div id="service-controls" className="bg-[var(--card)] border border-[var(--border)] rounded-2xl md:rounded-3xl p-4 md:p-8 shadow-2xl mt-8 md:mt-10 scroll-mt-24">
