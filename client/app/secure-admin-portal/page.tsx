    ...
    <main className="min-h-screen bg-[var(--background)] text-[var(--foreground)] transition-all duration-300">
      ...
      {showListingForm && (
        <div className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center px-4 py-8 overflow-y-auto">
          <div className="bg-[var(--card)] border border-[var(--border)] rounded-3xl p-8 w-full max-w-lg shadow-2xl my-auto">
            <div className="flex items-center justify-between mb-6">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-6 md:py-10">
        ...
        <div className="bg-[var(--card)] border border-[var(--border)] rounded-2xl md:rounded-3xl p-5 md:p-8 shadow-2xl mt-10">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-5 mb-8">
            <h2 className="text-2xl md:text-3xl font-bold">Marketplace Listings</h2>
          ...
          <div className="space-y-4">
            {filteredListings.map((listing) => (
              ...
              >
                <div>
                  <span className="inline-block bg-blue-600/20 text-blue-400 text-xs font-bold px-3 py-1 rounded-full uppercase mb-2">
                    {listing.platform}
                  </span>
                ...
                <div className="flex flex-col md:items-end gap-3">
                  <div className={`px-3 py-1 rounded-xl text-xs font-semibold w-fit ${listingStatusColors[listing.status]}`}>
